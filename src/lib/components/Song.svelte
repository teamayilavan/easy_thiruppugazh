...
<a href={`song/${song.id}`}>
	<div class="bg-card dark:bg-dcard hover:bg-accent hover:dark:bg-daccent w-84 lg:w-56 rounded-md px-2 py-2 shadow-sm">
		<p class="noto text-text dark:text-dtext font-medium">{song.title}</p>
		<p class="mt-1 text-sm">{song.place}</p>
