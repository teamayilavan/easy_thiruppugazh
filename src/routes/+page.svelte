...
<svelte:head>
	...
	<meta
		name="description"
		content="சிறப்பு மிக்க திருப்புகழில் படிப்பதற்கு எளிதனா 50 திருப்புகழ் பாடல்களை தொகுத்து இந்த
...
<div class="intro text-text-body mx-auto mt-8 grid max-w-3xl gap-4 text-sm md:text-lg">
	...
	<div class="second">
		<p>
			இத்தகைய சிறப்பு மிக்க திருப்புகழில் படிப்பதற்கு எளிதனா திருப்புகழ் பாடல்களை தொகுத்து இந்த
			வலைத்தளத்தில் வழங்கியுள்ளோம். பாடல்களுக்கு பொருளுரை, விளக்கவுரை மற்றும் இசை வடிவில் எவ்வாறு
			பாடுவது என்பன கொடுத்துள்ளோம்.
		</p>
	</div>
...
<div class="baloo mt-8 text-center font-medium">
	<p>பாடல்கள்</p>
</div>
<div
	class="mx-auto mt-4 flex flex-col items-center justify-center gap-2 text-center align-middle md:flex-row md:gap-5"
>
...
<div class="mt-4">
	<h2 class="baloo text-highlight-text text-center text-lg font-bold">நான்கு வரிகள்</h2>
...
<div class="mt-4">
	<h2 class="baloo text-highlight-text text-center text-lg font-bold">
		எட்டு வரிகள், மூன்று வார்த்தைகள்
	</h2>
	<div class="mt-4 flex flex-wrap justify-center gap-4 py-4">
		{#each songs.with_3_words as song}
			<Song {song} />
		{/each}
	</div>
</div>
<hr class="text-text-gray" />
<div class="mt-4">
	<h2 class="baloo text-highlight-text text-center text-lg font-bold">மற்றயவை</h2>
	<div class="mt-4 flex flex-wrap justify-center gap-4 py-4">
